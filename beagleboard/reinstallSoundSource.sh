...
# TODO: specify megaphone number, change IP and megaphone number to that number
...
# 3. copy files using scp [scp source_file_name username@destination_host:destination_folder]
    scp /Users/grahambooth/Desktop/Megaphone/github/beagleboard/soundSource/soundSourceStartup.scd ${USERNAME}@${HOSTNAME}:/home/debian/ChineseWhispers/code;
    scp /Users/grahambooth/Desktop/Megaphone/github/cwClasses/cwSoundSource.sc ${USERNAME}@${HOSTNAME}:/home/debian/.local/share/SuperCollider/Extensions/ChineseWhispers;
    ...
    scp -r /Users/grahambooth/Desktop/Megaphone/beagleboard_soundfiles_final/soundfiles ${USERNAME}@${HOSTNAME}:/home/debian/ChineseWhispers;
# scp /Users/grahambooth/Desktop/Megaphone/github/beagleboard/cwSoundSourceBoot.sh debian@192.168.2.1:/etc/init.d;
